  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">방문 기록 조회</h1>
          <p className="text-gray-500">제출된 모든 방문일지 기록을 확인합니다.</p>
        </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            ...
            >
              <div className="p-6 border-b border-gray-100 flex items-center justify-between">
                <h2 className="text-xl font-bold text-gray-900">방문 기록 상세</h2>
              ...
              <div className="flex-1 overflow-y-auto p-8 space-y-6">
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <p className="text-xs font-bold text-gray-400 uppercase mb-1">방문자명</p>
                    <p className="text-lg font-bold text-gray-900">{selectedLog.visitorName}</p>
                  </div>
                  <div>
                    <p className="text-xs font-bold text-gray-400 uppercase mb-1">연락처</p>
                    <p className="text-lg font-bold text-gray-900">{selectedLog.visitorContact}</p>
                  </div>
                  <div>
                    <p className="text-xs font-bold text-gray-400 uppercase mb-1">방문 목적</p>
                    <p className="text-gray-900">{selectedLog.purposeName}</p>
                  </div>
                  <div>
                    <p className="text-xs font-bold text-gray-400 uppercase mb-1">방문 일시</p>
                ...
                <div className="pt-6 border-t border-gray-100">
                  <p className="text-xs font-bold text-gray-400 uppercase mb-4">입력 데이터</p>
